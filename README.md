...
- Lead Case Study Assignment by Sana Aafreen.ipynb: The python file showing coding and data analysis
- Assignment Subjective Questions Answers.pdf : Some subjective questions answered
- Lead Score Case Study by Sana Aafreen.pdf : Final Presentation
- Leads.csv : Data worked on
- Leads Data Dictionary.xlsx : Data Dictionary
- Lead Case Study Summary by Sana Aafreen: Summary on what's done in the entire py file
